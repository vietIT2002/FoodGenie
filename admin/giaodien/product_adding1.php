    ...
    <div class="box-contentt">
        <form name="product-formadd" method="POST" action="./xulythem.php" enctype="multipart/form-data">
            ...
            <div class="wrap-field">
                ...
                <select class="form-control" name="idtl"><?php while ($row = mysqli_fetch_array($theloai)) { ?>
            ...
            <div class="wrap-field">
                ...
                <select class="form-control" name="idncc"><?php while ($row = mysqli_fetch_array($nhacungcap)) { ?>
